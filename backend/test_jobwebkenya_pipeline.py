...
async def test_jobwebkenya_pipeline():
    ...
    logger.info(f"JobWebKenya pipeline result: {success_count}/3 jobs processed successfully")
...
async def test_multiple_sources():
    ...
    myjobmag_scraper = __import__('app.scrapers.spiders.myjobmag', fromlist=['JobScraper']).JobScraper()
    ...
    async def main():
        try:
            ...
            if success1 and success2:
                ...
                logger.info("Both MyJobMag and JobWebKenya can connect to main database!")
