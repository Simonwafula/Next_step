...
def upgrade() -> None:
    ...
    op.create_table('linkedin_profiles',
        ...
        sa.Column('experience', postgresql.JSONB(astext_type=sa.Text()), nullable=False, default=sa.text("'[]'::jsonb")),
        sa.Column('education', postgresql.JSONB(astext_type=sa.Text()), nullable=False, default=sa.text("'[]'::jsonb")),
        sa.Column('skills', postgresql.JSONB(astext_type=sa.Text()), nullable=False, default=sa.text("'[]'::jsonb")),
        sa.Column('certifications', postgresql.JSONB(astext_type=sa.Text()), nullable=False, default=sa.text("'[]'::jsonb")),
        sa.Column('languages', postgresql.JSONB(astext_type=sa.Text()), nullable=False, default=sa.text("'[]'::jsonb")),
        sa.Column('auto_sync_enabled', sa.Boolean(), nullable=False, default=True),
        sa.Column('sync_frequency', sa.String(length=50), nullable=False, default='weekly'),
        sa.Column('last_synced', sa.DateTime(), nullable=True),
        sa.Column('sync_status', sa.String(length=50), nullable=False, default='active'),
        sa.Column('sync_errors', postgresql.JSONB(astext_type=sa.Text()), nullable=False, default=sa.text("'{}'::jsonb")),
    ...
    op.create_index(op.f('ix_linkedin_profiles_linkedin_id'), 'linkedin_profiles', ['linkedin_id'], unique=False)
    ...
    op.create_table('calendar_integrations',
        ...
        sa.Column('timezone', sa.String(length=100), nullable=False, default='Africa/Nairobi'),
        sa.Column('is_active', sa.Boolean(), nullable=False, default=True),
        sa.Column('auto_schedule_interviews', sa.Boolean(), nullable=False, default=True),
    ...
    op.create_index('idx_user_calendar_provider', 'calendar_integrations', ['user_id', 'provider'], unique=False)
    ...
    op.create_table('calendar_events',
        ...
        sa.Column('attendees', postgresql.JSONB(astext_type=sa.Text()), nullable=False, default=sa.text("'[]'::jsonb")),
        ...
        sa.Column('reminder_times', postgresql.JSONB(astext_type=sa.Text()), nullable=False, default=sa.text("'[]'::jsonb")),
        sa.Column('created_at', sa.DateTime(), nullable=False, default=sa.text('CURRENT_TIMESTAMP')),
        sa.Column('updated_at', sa.DateTime(), nullable=False, default=sa.text('CURRENT_TIMESTAMP')),
        ...
        sa.ForeignKeyConstraint(['related_job_id'], ['job_post.id'], ),
        sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
        sa.PrimaryKeyConstraint('id')
    )

    # Create ATS integrations table
    op.create_table('ats_integrations',
        sa.Column('id', sa.Integer(), nullable=False),
        ...
        sa.Column('webhook_events', postgresql.JSONB(astext_type=sa.Text()), nullable=False, default=sa.text("'[]'::jsonb")),
        sa.Column('last_synced', sa.DateTime(), nullable=True),
        sa.Column('sync_status', sa.String(length=50), nullable=False, default='active'),
        sa.Column('sync_errors', postgresql.JSONB(astext_type=sa.Text()), nullable=False, default=sa.text("'{}'::jsonb")),
    ...
    op.create_index('idx_org_ats_provider', 'ats_integrations', ['organization_id', 'ats_provider'], unique=False)

    # Create ATS job sync table
    op.create_table('ats_job_syncs',
        sa.Column('id', sa.Integer(), nullable=False),
        ...
        sa.Column('first_synced', sa.DateTime(), nullable=False, default=sa.text('CURRENT_TIMESTAMP')),
        sa.Column('last_synced', sa.DateTime(), nullable=False, default=sa.text('CURRENT_TIMESTAMP')),
        sa.Column('sync_status', sa.String(length=50), nullable=False, default='active'),
        sa.Column('sync_errors', postgresql.JSONB(astext_type=sa.Text()), nullable=False, default=sa.text("'{}'::jsonb")),
        sa.Column('ats_metadata', postgresql.JSONB(astext_type=sa.Text()), nullable=False, default=sa.text("'{}'::jsonb")),
        ...
        sa.ForeignKeyConstraint(['ats_integration_id'], ['ats_integrations.id'], ),
        sa.ForeignKeyConstraint(['job_post_id'], ['job_post.id'], ),
        sa.PrimaryKeyConstraint('id')
    )
    op.create_index('idx_ats_job_sync', 'ats_job_syncs', ['ats_integration_id', 'ats_job_id'], unique=True)

    # Create ATS application sync table
    op.create_table('ats_application_syncs',
        sa.Column('id', sa.Integer(), nullable=False),
        sa.Column('ats_integration_id', sa.Integer(), nullable=False),
        ...
        sa.Column('interview_feedback', postgresql.JSONB(astext_type=sa.Text()), nullable=False, default=sa.text("'{}'::jsonb")),
        sa.Column('sync_status', sa.String(length=50), nullable=False, default='active'),
        sa.Column('sync_errors', postgresql.JSONB(astext_type=sa.Text()), nullable=False, default=sa.text("'{}'::jsonb")),
        sa.Column('created_at', sa.DateTime(), nullable=False, default=sa.text('CURRENT_TIMESTAMP')),
        sa.Column('updated_at', sa.DateTime(), nullable=False, default=sa.text('CURRENT_TIMESTAMP')),
    ...
    op.create_index('idx_ats_app_sync', 'ats_application_syncs', ['ats_integration_id', 'ats_application_id'], unique=True)

    # Create integration activity log table
    op.create_table('integration_activity_logs',
        sa.Column('id', sa.Integer(), nullable=False),
        ...
        sa.Column('activity_data', postgresql.JSONB(astext_type=sa.Text()), nullable=False, default=sa.text("'{}'::jsonb")),
    ...
    op.create_index('idx_integration_activity', 'integration_activity_logs', ['integration_type', 'integration_id', 'created_at'], unique=False)
    op.create_index(op.f('ix_integration_activity_logs_created_at'), 'integration_activity_logs', ['created_at'], unique=False)


def downgrade() -> None:
    # Drop tables in reverse order
    op.drop_index(op.f('ix_integration_activity_logs_created_at'), table_name='integration_activity_logs')
