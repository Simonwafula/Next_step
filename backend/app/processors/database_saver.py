...
class JobDatabaseSaver:
    ...
    def save_job_data(self, cleaned_data: Dict) -> Optional[int]:
        ...
        try:
            ...
            existing_job = db.query(JobPost).filter(JobPost.url == cleaned_data.get('url')).first()
            if existing_job:
    ...
    def _get_or_create_organization(self, db: Session, company_name: str) -> Optional[int]:
    ...
    def _get_or_create_title_norm(self, db: Session, cleaned_data: Dict) -> Optional[int]:
        ...
        title_norm = db.query(TitleNorm).filter(
    ...
    def get_job_stats(self) -> Dict:
        ...
        try:
            ...
            recent_jobs = db.query(JobPost).filter(JobPost.first_seen >= week_ago).count()
