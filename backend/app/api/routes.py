...
def search(
    ...
    county: str | None = Query(None, description="County/region filter"),
    sector: str | None = Query(None, description="Organization sector filter"),
    high_confidence_only: bool = Query(
        False,
        description="Return only high-confidence jobs",
    ),
