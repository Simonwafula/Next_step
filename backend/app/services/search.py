...
from ..ml.embeddings import embed_text, parse_embedding
from ..normalization.titles import normalize_title, get_careers_for_degree
import numpy as np
import re
...
def generate_match_explanation(
    query: str, job_post: JobPost, title_norm: TitleNorm | None, similarity_score: float
) -> str:
    ...
    if (
        query
        and job_post.description_raw
        and query.lower() in job_post.description_raw.lower()
    ):
