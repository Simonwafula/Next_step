...
class BrighterMondayScraper(BaseScraper):
    ...
    def __init__(self):
        super().__init__(
            name="BrighterMonday", base_url="https://www.brightermonday.co.ke"
        )
    ...
    async def scrape_job_listings(
        ...
        try:
            ...
            job_cards = (
                ...
                or soup.find_all("div", class_="search-job")
            ...
            for card in job_cards[:limit]:
                try:
                    ...
                    # Extract location
                    location_elem = card.find("div", class_="location") or card.find(
                    ...
                    job_type = (
                        job_type_elem.get_text(strip=True) if job_type_elem else None
                    )
