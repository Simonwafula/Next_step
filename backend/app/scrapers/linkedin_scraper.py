...
class LinkedInScraper(BaseScraper):
    ...
    def __init__(self):
        super().__init__(name="LinkedIn", base_url="https://www.linkedin.com/jobs")
    ...
    async def scrape_job_listings(
        ...
        search_url = (
            f"{self.base_url}/search/?keywords={search_query}&location={location_query}"
        )
        ...
        try:
            ...
            job_cards = soup.find_all(
                "div", class_=re.compile(r"job-search-card|base-search-card")
            )
            ...
            for card in job_cards[:limit]:
                try:
                    ...
                    title_elem = card.find(
                        ...
                        "a",
                        {
                            "data-tracking-control-name": re.compile(
                                r"public_jobs_jserp-result_search-card"
                            )
                        },
                    )
                    ...
                    job_record = self.create_job_record(
                        ...
                        raw_data={"company": company, "source_location": job_location},
                    )
