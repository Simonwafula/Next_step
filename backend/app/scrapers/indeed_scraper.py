...
class IndeedScraper(BaseScraper):
    ...
    def __init__(self):
        super().__init__(name="Indeed", base_url="https://ke.indeed.com")
    ...
    async def scrape_job_listings(
        ...
        try:
            ...
            job_cards = (
                ...
                or soup.find_all("a", {"data-jk": True})
            )
            ...
            for card in job_cards[:limit]:
                try:
                    ...
                    if title_elem.name == "a":
                        ...
                        if not title_link:
                            continue
                        title = title_link.get("title") or title_link.get_text(
                            strip=True
                        )
                    ...
                    # Extract company
                    company_elem = card.find("span", class_="companyName") or card.find(
