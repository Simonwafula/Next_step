...
def generate_embeddings(input_csv, output_csv, model_name='intfloat/e5-small-v2'):
    ...
    texts = [f"query: {row['title_norm']} {row['description_clean']}" for _, row in df.iterrows()]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--input", default="artifacts/v1_baseline_v2/jobs_normalized.csv")
